 ...
 */
 ...
 $dbconfig['dev'] = array('localhost', 'todomanager', 'root', 'Zth@111111', 'mysql', true, 'collate'=>'utf8_unicode_ci', 'charset'=>'utf8');
 $dbconfig['prod'] = array('localhost', 'todomanager', 'root', 'Zth@111111', 'mysql', true, 'collate'=>'utf8_unicode_ci', 'charset'=>'utf8');
 $dbmap['user']['has_many']['todoitem'] = array('foreign_key'=>'user_id');
 $dbmap['todoItem']['belongs_to']['User'] = array('foreign_key'=> 'id');
